...
contract BoardContract is AccessControl, VRFConsumerBase {
	...
	event NewPawnRegistered(uint16 indexed _edition, uint256 indexed _pawnID);
		...
		)
	{
		...
		BoardStruct storage board = boards[0];
		board.nbOfLands = 40;
		board.rarityLevel = 2;
		board.isBuildingLand[1] = true;
		board.isBuildingLand[3] = true;
		board.isBuildingLand[5] = true;
		board.isBuildingLand[6] = true;
		board.isBuildingLand[8] = true;
		board.isBuildingLand[9] = true;
		board.isBuildingLand[11] = true;
		board.isBuildingLand[13] = true;
		board.isBuildingLand[14] = true;
		board.isBuildingLand[15] = true;
		board.isBuildingLand[16] = true;
		board.isBuildingLand[18] = true;
		board.isBuildingLand[19] = true;
		board.isBuildingLand[21] = true;
		board.isBuildingLand[23] = true;
		board.isBuildingLand[24] = true;
		board.isBuildingLand[25] = true;
		board.isBuildingLand[26] = true;
		board.isBuildingLand[27] = true;
		board.isBuildingLand[29] = true;
		board.isBuildingLand[31] = true;
		board.isBuildingLand[32] = true;
		board.isBuildingLand[34] = true;
		board.isBuildingLand[35] = true;
		board.isBuildingLand[37] = true;
		board.isBuildingLand[39] = true;
	...
	function newBoard(
		...
		editionMax += 1;
		BoardStruct storage board = boards[editionMax];
		board.nbOfLands = _nbOfLands;
		board.rarityLevel = _rarityLevel;
		for (uint8 i = 0; i < _buildingLands.length; i++) {
			require(_buildingLands[i] < board.nbOfLands, "land index out of range");
			board.isBuildingLand[_buildingLands[i]] = true;
		}

		board.buildType = _buildType;
		board.nb_pawns_max = _maxPawns;
	...
	function register(uint16 _edition, uint256 _pawnID) external onlyRole(MANAGER_ROLE) returns (bool isOnBoarded) {
		...
		emit NewPawnRegistered(_edition, _pawnID);
